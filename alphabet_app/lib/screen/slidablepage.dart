...
List<String> audio = ["a_file.mp3", "e_file.mp3","i_file.mp3", "o_file.mp3","v_file.mp3","va_file.mp3","ve_file.mp3","vi_file.mp3","vo_file.mp3","error.mp3"];
  ...
  void firstsound() {
    ...
    void case1lettre() {
      ...
      if ((distancex >= 100) && (distancex <= 235)) {        //Premieres cases sont au minimum a une distance de 100 et max a 235 
        tangente = (distancey.abs() / distancex);
        //print("Tangente = $tangente");
        if (distancey < 0) {               //   Les 2 cases au dessus ont un y négatif.
    ...
    void duosound() {
      ...
      if (distancex >= 310) {     //Premieres cases sont au minimum a une distance de 100 et max a 235 
        tangente = (distancey.abs() / distancex);
        //print("Tangente = $tangente");
        if (distancey < 0) {  
          ...
          etape = 0;     // L'etape a bien été réaliser, il faut maintenant repasser par les cases d avant.
        }
